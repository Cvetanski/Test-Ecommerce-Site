<footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <p class="pull-left">Copyright © Omada Technology. All rights reserved.</p>
                <p class="pull-right">Designed by <span><a target="_blank" href="https://www.facebook.com/omadatechnology/">Omada Technology</a></span></p>
            </div>
        </div>
    </div>
</footer><!--/Footer-->
