                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            ...
                            <li><a href="#"><i class="fa fa-envelope"></i> info@omadatechnology.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="https://www.facebook.com/omadatechnology"><i class="fa fa-facebook"></i></a></li>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{url('https://www.facebook.com/omadatechnology')}}"><img src="{{asset('frontEnd/images/home/omada.png')}}" alt="" /></a>
                    </div>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li><a href="https://omadatechnology.com/#contact1" target="_blank">Contact</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-3">
